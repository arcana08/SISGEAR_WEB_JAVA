    ...
    <div class="container text-center">
        <div class="row">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="col-form-label">LISTADO DE PROYECTILES</h1>
                <div>
                    <div class="search-bar">
                        ...
                        <a class="btn btn-primary btn-print" id="imprimir" href="reportesv/Rproyectiles.jsp" target="_blank" title="Imprimir Reporte">
            ...
            <div class="modal-content">
                <form id="form">
                    <div class="modal-header">
                        <h1 class="col-form-label">FORMULARIO DE PROYECTILES</h1>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <label for="nombre" class="col-sm-4 col-form-label text-sm-right">CANTIDAD</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nombre" id="nombre" placeholder="123">
                            </div>
                        </div>
                    </div>
                </form>
