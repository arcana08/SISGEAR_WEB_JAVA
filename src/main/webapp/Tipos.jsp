            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    <div class="search-bar">
                       ...
                       <a class="btn btn-primary btn-print" id="imprimir" href="reportesv/Rtipos.jsp" target="_blank" title="Imprimir Reporte">
            ...
            <div class="modal-content">
                <form id="form">
                    <div class="modal-header">
                        <h1 class="col-form-label">FORMULARIO DE TIPOS</h1>
