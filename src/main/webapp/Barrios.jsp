    ...
    <div class="container text-center">
        <div class="row">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="col-form-label">LISTADO DE BARRIOS</h1>
                <div>
            ...
            <div class="modal-content">
                <form id="form">
                    <div class="modal-header">
                        <h1 class="col-form-label">FORMULARIO DE BARRIOS</h1>
                        <input type="hidden" id="listar" name="listar" value="cargar">
                        <input type="hidden" id="pkid" name="pkid" value="">
                    </div>
                    <div class="modal-body">
                        <div class="form-group row">
                            <label for="nombre" class="col-sm-4 col-form-label text-sm-right">BARRIO</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Nombre">
                            </div>
                        </div>
                        <div class="form-group row mt-3">
                            <label for="dep" class="col-sm-4 col-form-label text-sm-right">PAIS, DEPARTAMENTO, CIUDAD</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <input type="hidden" class="form-control" name="dep" id="dep" placeholder="click para asignar">
                                    <input data-bs-target="#exampleModal2" data-bs-toggle="modal" type="text" class="form-control" name="ndep" id="ndep" onclick="" placeholder="click para asignar" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="exampleModal2" aria-hidden="true" aria-labelledby="exampleModal2" tabindex="-1">
        <div class="modal-dialog" style="max-width: 800px;">
            <div class="row">
                <div class="modal-content">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h1 class="col-form-label">LISTADO DE CIUDADES</h1>
                        <div>
                            <div class="search-bar">
...
<script>
    ...
    function rellenarjs(a, b, c, d, e, f) {
        $("#pkid").val(a);
        $("#nombre").val(b);
        $("#dep").val(c);
        $("#ndep").val(f+ " - " + e + " - " + d);
