            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    <div class="search-bar">
                        ...
                        <a class="btn btn-primary btn-print" id="imprimir" href="reportesv/Rcalibres.jsp" target="_blank" title="Imprimir Reporte">
            ...
            <div class="modal-content">
                <form id="form">
                    <div class="modal-header">
                        <h1 class="col-form-label">FORMULARIO DE CALIBRES</h1>
                        <input type="hidden" id="listar" name="listar" value="cargar">
                        <input type="hidden" id="pkid" name="pkid" value="">
                    </div>
                    <div class="modal-body">
                        <div class="form-group row">
                            <label for="datos" class="col-sm-4 col-form-label">CALIBRE</label>
                            <div class="col-sm-8">
