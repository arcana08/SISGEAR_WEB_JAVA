            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    <div class="search-bar">
                        ...
                        <a class="btn btn-primary btn-print" id="imprimir" href="reportesv/Rmodelos.jsp" target="_blank" title="Imprimir Reporte">
            ...
            <div class="modal-content">
                <form id="form">
                    <div class="modal-header">
                        <h1 class="col-form-label">FORMULARIO DE MODELOS</h1>
                        <input type="hidden" id="listar" name="listar" value="cargar">
                        <input type="hidden" id="pkid" name="pkid" value="">
                    </div>
                    <div class="modal-body">
                        <div class="form-group row">
                            <label for="nombre" class="col-sm-4 col-form-label text-sm-right">MODELO</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Nombre">
                            </div>
                        </div>
                        <div class="form-group row mt-3">
                            <label for="pais" class="col-sm-4 col-form-label text-sm-right">MARCAS</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <input type="hidden" class="form-control" name="marca" id="marca" placeholder="click para asignar">
                                    <input data-bs-target="#exampleModal2" data-bs-toggle="modal" type="text" class="form-control" name="nmarca" id="nmarca" onclick="" placeholder="click para asignar" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="exampleModal2" aria-hidden="true" aria-labelledby="exampleModal2" tabindex="-1">
        <div class="modal-dialog">
            <div class="row">
                <div class="modal-content">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h1 class="col-form-label">LISTADO DE MARCAS</h1>
                        <div>
                            <div class="search-bar">
